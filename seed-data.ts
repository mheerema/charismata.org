 ...
 *
 * Creates 11 categories and 220 questions (20 per category).
...
const CATEGORIES: Category[] = [
  {
    ...
    questions: [
      ...
      "I'm drawn to books, podcasts, or courses that help me understand God and the Bible more deeply.",
  ...
  },
  {
    ...
    questions: [
      ...
      "I'm more excited about imagining what could be than keeping things the way they are.",
  ...
  },
  {
    ...
    questions: [
      ...
      "I notice planning problems — schedule conflicts, missing supplies, unclear responsibilities — before others do.",
      ...
      "I tend to think about schedules, what needs to happen first, and how to use people and resources well.",
  ...
  },
  {
    ...
    questions: [
      ...
      "It really bothers me when I see people giving up on things that matter.",
      ...
      "I take the health of the church — what it teaches and how it lives — very seriously.",
      ...
      "I can often see the real problem in a disagreement, even when it's hidden beneath the surface.",
      "I value alignment between what someone says and how they live.",
      "People have come to me when they need someone to tell them the straight truth.",
  ...
  },
  {
    ...
    questions: [
      ...
      "I strongly believe that many things go undone simply because no one has prayed for them.",
      ...
      "Praying for other people is one of the most important things I do.",
  ...
  },
  {
    ...
    questions: [
      ...
      "I look for the best places to give — where generosity will make a lasting difference.",
      ...
      "I pay attention to how money is used in the church and care that it's managed wisely.",
  ...
  },
  {
    ...
    questions: [
      ...
      "I tend to see word pictures and comparisons that help explain hard-to-grasp ideas in a clear way.",
      ...
      "I believe beauty and truth go hand in hand.",

...
export const GIFT_NEXT_STEPS: Record<string, GiftNextStep> = {
  "Word & Wisdom": {
    ...
    steps: [
      ...
      "Ask someone you've taught what was unclear, and let the gap in their understanding tell you where to grow, rather than your own sense of how you delivered it.",
    ],
    scripture:
  ...
  "Prophetic & Discernment": {
    ...
    steps: [
      ...
      "Where you sense something is off, do the work of articulating why from Scripture before you say anything, so your discernment serves the body instead of merely unsettling it.",
    ],
    scripture:
  ...
  "Creative & Communication": {
    ...
    steps: [
      "Use one of your creative abilities this week in direct service of your church or someone in it, beyond your own portfolio.",
...
export const RESULTS_CALLOUT: {
  ...
  body: 'Hold these gently. A gift is not an excuse. A low score in mercy does not exempt you from showing mercy. Every believer is still called to evangelize, give, serve, and care, whatever the inventory says, because these are commands for the whole church and not assignments for a few. A low score is not a deficiency. It simply means your tendencies lie elsewhere, and what you lack the body around you supplies. Gifts are given "as He wills" (1 Corinthians 12:11), and they grow, deepen, and shift across seasons; today\'s result is a snapshot, not a sentence. This inventory is directional, not diagnostic. It points you toward where to look and whom to ask, and never toward a fixed verdict on who you are.',
  segments: [
    { text: "Hold these gently. " },
    {
      bold: "A gift is not an excuse.",
      text: " A low score in mercy does not exempt you from showing mercy. Every believer is still called to evangelize, give, serve, and care, whatever the inventory says, because these are commands for the whole church and not assignments for a few. ",
    },
    {
    ...
    },
    {
      ...
      text: " It points you toward where to look and whom to ask, and never toward a fixed verdict on who you are.",
    },
  ],
};
...
export const CONFIRM_CONTENT: {
  ...
  intro:
    'You just answered a set of questions about yourself. That is a useful place to begin, and it is not the finish line. Paul says each believer is given a gift "for the common good" (1 Corinthians 12:7), and he spends most of 1 Corinthians 12 insisting that no member of the body can assess itself in isolation. The eye needs the hand, and the head needs the feet (12:14–26). A gift is something the body watches you exercise, not something you assign yourself. When the early church needed to identify gifted servants, the congregation looked for those already known to be "full of the Spirit and of wisdom" and set them forward (Acts 6:3). So take what this inventory suggested and bring it to people who actually know you. Let them confirm it, correct it, or name something it missed.',
  howToUse:
  ...
  prompts: [
    {
      ...
      quote:
        '"The inventory suggested [gift] is one of my strengths. Set the test aside for a moment. Does that line up with what you\'ve actually watched me do?"',
    },
    {
      title: "Where have you seen it bear fruit?",
      quote:
        '"Can you point to a specific time you saw this at work in me, where it actually helped someone or built something up?"',
    ...
    },
    {
      ...
      quote:
        '"Where has this same tendency gone wrong: overstepped, worn people out, or served me more than the body?"',
  ...
  bodyCanName: {
    ...
    body: 'An inventory can only measure what it thought to ask. The body sees what the instrument cannot. Some of the clearest gifting you carry may be something a list of questions would never surface, and the people who have served beside you have watched it for years. If two or three of them independently name the same thing, pay closer attention to that than to any score on a screen.',
  },
  affirmationsNote:
